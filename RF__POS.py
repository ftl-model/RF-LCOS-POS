...
# BNP: numerical input
BNP = st.number_input("BNP（ng/L）:", min_value=100.00, max_value=50000.00, value=125.00)
...
BP_65_time = st.number_input("MAP_65_time（min）:", min_value=0, max_value=1000, value=120)
...
feature_values = [ age, preop_ucg_EF, BNP, DBIL ,T3, UREA, optime , MAP_65_time, Lac_1st_postop]
